...
public class UpdatedEcel {
	...
	public void AddVariants(String EmployeeName, String EmployeeNumber, String ManagerName, String OKR1, String OKR2,
		   ...
		   String[] OKRArray = new String[] {OKR1,OKR2,OKR3,OKR4,OKR5,OKR6,OKR7,OKR8,OKR9,
	        		OKR10,OKR11,OKR12,OKR13,OKR14,OKR15,OKR16,OKR17,OKR18,OKR19,OKR20,OKR21,OKR22,OKR23,OKR24,OKR25,OKR26};
	        
	        String[] KRArray = new String[] {KR1,KR2,KR3,KR4,KR5,KR6,KR7,KR8,KR9,
	        		KR10,KR11,KR12,KR13,KR14,KR15,KR16,KR17,KR18,KR19,KR20,KR21,KR22,KR23,KR24,KR25,KR26,KR27,KR28,KR29};
	...
	public void testValidateData(String[] data) {
	   

	    for (int i = 0; i < data.length; i++) {
	        String excelData = data[i];
    ...
    @Test(dataProvider = "data-provider")
	public void DataGetter(String EmployeeName, String EmployeeNumber, String ManagerName, String OKR1, String OKR2,
			String OKR3, String OKR4, String OKR5, String OKR6, String OKR7, String OKR8, String OKR9, String OKR10,
			String OKR11, String OKR12, String OKR13, String OKR14, String OKR15, String OKR16, String OKR17,
			String OKR18, String OKR19, String OKR20, String OKR21, String OKR22, String OKR23, String OKR24,
			String OKR25, String OKR26, String KR1, String KR2, String KR3, String KR4, String KR5, String KR6,
		  ...
		  String[] OKRArray = new String[]
		  {OKR1,OKR2,OKR3,OKR4,OKR5,OKR6,OKR7,OKR8,OKR9,
		  OKR10,OKR11,OKR12,OKR13,OKR14,OKR15,OKR16,OKR17,OKR18,OKR19,OKR20,OKR21,OKR22
		  ,OKR23,OKR24,OKR25,OKR26};
		  
		  String[] KRArray = new String[] {KR1,KR2,KR3,KR4,KR5,KR6,KR7,KR8,KR9,
		  KR10,KR11,KR12,KR13,KR14,KR15,KR16,KR17,KR18,KR19,KR20,KR21,KR22,KR23,KR24,
		  KR25,KR26,KR27,KR28,KR29};
		  
		  
		  ArrayList<String> OKRID= getDataFromString(OKRArray); 
		  for(int i=0 ;
		  i<=OKRID.size();i++) 
		  { 
			  System.out.println(OKRID.get(i)); 
			  }
	...
	public ArrayList<String> getDataFromString(String[] list) throws InterruptedException
	{
		String[] parts = null;
	...
	public static void removeNullAndEmpty(List<String> list) {
